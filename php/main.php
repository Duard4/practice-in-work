...
<section class="values">
    <div class="card-wrapper">
        <?php 
            $values_p1 = ["Відданість Батьківщині та її національній ідеї", "Гордість вважати себе українцем",
                        "Відданість Батьківщині та її національній ідеї", "Підвищення обороноздатності"];
            $values_p2 = ["“Серцем до України: Глибокий зв'язок зі своєю нацією”", "“Українська Душа: Гордість нації в кожному серці”",
...
<div class="container">
    <img src="../img/main/Rectangle 5161.png" class="bg-img">
